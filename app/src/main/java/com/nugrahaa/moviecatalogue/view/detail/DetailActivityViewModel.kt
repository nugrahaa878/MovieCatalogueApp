...
class DetailActivityViewModel: ViewModel() {
    ...
    fun getTvShowById(id: Int, listTvShow: ArrayList<TvShowEntity>): TvShowEntity = DataDummy.getTvShowById(id, listTvShow)

    fun getMovieById(id: Int, listMovie: ArrayList<MovieEntity>): MovieEntity = DataDummy.getMoviesById(id, listMovie)
